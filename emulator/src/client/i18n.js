(function () {
    const I18N = {
        en: {
            ...
            "map.step1Desc": "As the buyer, discover a service and try an illustrative checkout before opening the publisher landing page.",
            "map.step2": "Activate",
            ...
            "map.learnMore": "Terms and how it all works — see the publisher app →",
            ...
            "journey.mapLabel": "Demo steps",
            "journey.badge": "ILLUSTRATIVE PURCHASE UX",
            "journey.startHint": "Discover a service → demo checkout → the same publisher landing page.",
            "journey.startTitle": "Choose a demo purchase route",
            "journey.emulatorNavigation": "Emulator navigation",
            ...
            "journey.web-card.surface": "Marketplace Web · demo listing",
            ...
            "journey.web-azure.surface": "Marketplace Web · demo listing",
            ...
            "journey.azure-portal.surface": "Azure portal · demo listing",
            ...
            "journey.configureNext": "Open publisher landing → configure",
            ...
            "index.sampleMarketplaceBehaviour": "Demo checkout — same offer and plan",
            ...
            "index.profileInfo": "Demo profile values only. No Microsoft account has been read, and no real payment is collected.",
            ...
            "index.termsHtml": "Continue passes a demo token to the publisher landing page for configuration. No real order is placed; this emulator creates its subscription record when the token is resolved.",
        ...
        ja: {
            ...
            "map.step1Desc": "購入者としてサービスを探し、購入画面のデモからパブリッシャーのランディングページへ進みます。",
            "map.step2": "有効化",
            ...
            "map.learnMore": "用語としくみは、パブリッシャーのアプリの「しくみを学ぶ」へ →",
            ...
            "journey.mapLabel": "デモのステップ",
            "journey.badge": "購入 UX の説明用デモ",
            "journey.startHint": "サービスを探す → 購入画面のデモ → 同じパブリッシャーのランディングページへ。",
            "journey.startTitle": "購入経路のデモを選ぶ",
            "journey.emulatorNavigation": "エミュレーターのナビゲーション",
            ...
            "journey.web-card.surface": "Marketplace Web · 掲載画面のデモ",
            ...
            "journey.web-azure.surface": "Marketplace Web · 掲載画面のデモ",
            ...
            "journey.azure-portal.surface": "Azure portal · 掲載画面のデモ",
            ...
            "journey.configureNext": "ランディングページを開いて設定 →",
            ...
            "index.sampleMarketplaceBehaviour": "購入画面のデモ — 同じオファーとプラン",
            ...
            "index.profileInfo": "プロフィールはデモ用の値です。Microsoft アカウントの情報は取得しておらず、実際の決済も行いません。",
            ...
            "index.termsHtml": "続行すると設定用のランディングページにデモトークンを渡します。実際の注文は行いません。このエミュレーターはトークンの Resolve 時にサブスクリプションのレコードを作成します。",
