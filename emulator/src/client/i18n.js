(function () {
    const I18N = {
        en: {
            ...
            "experience.supportNote": "This page illustrates buying a service, not a working automation product. Purchase permissions and publisher responsibilities are explained in “How this works” in the map above.",
            ...
            "experience.checkoutHint": "Choose purchase details, review the demo order, then configure your account with the publisher.",
            ...
            "experience.configure": "Configure account",
            ...
            "experience.nextConfigure": "Next: configure your account",
            "experience.handoffNote": "Your purchase is not the end of setup. Continue to the publisher's landing page to sign in, link your account and activate the service.",
            "experience.boundary": "This is where the Microsoft-side purchase experience hands over to the page the publisher builds.",
            "experience.aboutSimulation": "About this simulated order",
            "experience.simulationRecord": "No payment or Marketplace order was created. This emulator creates its subscription record when the publisher resolves the demo token. Configure again opens the same purchase, not a new order.",
        ...
        ja: {
            ...
            "experience.supportNote": "サービスの購入体験を示すページであり、自動化製品そのものは実装していません。購入権限やパブリッシャーの担当範囲は、地図の「しくみを学ぶ」で確認できます。",
            ...
            "experience.checkoutHint": "購入内容を選んで注文を確認し、その後パブリッシャーのサイトでアカウントを構成します。",
            ...
            "experience.configure": "アカウントを構成する",
            ...
            "experience.nextConfigure": "次に、アカウントを構成します",
            "experience.handoffNote": "購入だけでは利用開始になりません。パブリッシャーのランディングページへ進み、サインイン・アカウントの紐付け・有効化を行います。",
            "experience.boundary": "ここが、Microsoft 側の購入体験からパブリッシャーが作る画面への引き渡しです。",
            "experience.aboutSimulation": "この購入シミュレーションについて",
            "experience.simulationRecord": "実際の決済・Marketplace の注文は作成していません。エミュレーターの契約記録は、パブリッシャーがデモトークンを Resolve したときに作成されます。再度「構成する」を押しても同じ購入を開きます。",
